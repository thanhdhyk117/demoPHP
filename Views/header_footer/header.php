...
<div class="search">
    <div class="search__form">
        <form class="search-bar__form" action="?act=shop" method="post">
            ...
            <input class="search__input" type="text" name="keyword" value="" placeholder="Tìm kiếm trong cửa hàng" aria-label="Search" autocomplete="on">
        </form>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-10 col-sm-8 col-md-5 col-lg-4">
                <p class="phone-no"><i class="anm anm-phone-s"></i> 097 107 1011</p>
            </div>
            ...
            <div class="col-2 col-sm-4 col-md-3 col-lg-4 text-right">
                ...
                <ul class="customer-links list-inline">
                        ...
                        <li><a href="?act=taikhoan&xuli=account">Xin chào <?=$_SESSION['login']['Ho']?> <?=$_SESSION['login']['Ten']?></a></li>
                        <li><a href="?act=taikhoan&xuli=dangxuat">Đăng xuất</a></li>
                      <?php
                    }else{ ?>
                          <li><a href="?act=taikhoan">Đăng nhập</a></li>
                        <li><a href="?act=wishlist">Danh sách yêu thích</a></li>
                        <?php } ?>
                </ul>
            </div>
        </div>
            ...
            <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                ...
                <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                    <ul id="siteNav" class="site-nav medium center hidearrow">
                        ...
                        <li class="lvl1 parent dropdown"><a href="?act=about">Về chúng tôi <i class="anm anm-angle-down-l"></i></a></li>
                        <li class="lvl1 parent dropdown"><a href="?act=contact">Liên hệ <i class="anm anm-angle-down-l"></i></a></li>
                          ...
                          <?php
                            ...
                            <li class="item">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="variant-cart">Đen / XL</div>
                        ...
                        <div class="total">
                            <div class="total-in">
                             ...
                             <div class="buttonSet text-center">
                                <a href="?act=cart" class="btn btn-secondary btn--small">Xem giỏ hàng</a>
                                <a href="?act=checkout" class="btn btn-secondary btn--small">Thanh toán</a>
                            </div>
                        </div>
                      <?php }else{ ?>
                        <div class="total">
                          <span><strong>Giỏ hàng của bạn hiện đang trống</strong></span>
                        </div>
                      <?php } ?>
                    </div>

...
<head>
  ...
  <title>7octobre Shop Admin</title>
  <!-- General CSS Files -->
      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        <div class="form-inline mr-auto">
          <ul class="navbar-nav mr-3">
            ...
            <li>
              <form class="form-inline mr-auto px-1">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Xin chào <?php echo Session::get('adminName');?></div>
              <a href="#" class="dropdown-item has-icon"> <i class="far fa-user"></i>Thông tin tài khoản</a>

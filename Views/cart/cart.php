        	...
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                	<div class="alert alert-success text-uppercase" role="alert">
						<!-- <i class="icon anm anm-truck-l icon-large"></i> &nbsp;<strong>Chúc mừng!</strong> Bạn được miễn phí giao hàng -->
					</div>
                	<form action="#" method="post" class="cart style2">
                		<table>
                          ...
                          <?php
                    		...
                    		<tfoot>
                                <tr>
                                    <td colspan="3" class="text-left"><a href="#" class="btn btn-secondary btn--small cart-continue">Tiếp tục mua sắm</a></td>
                                    <td colspan="3" class="text-right">
	                                    <button type="submit" name="clear" class="btn btn-secondary btn--small  small--hide">Làm mới giỏ hàng</button>

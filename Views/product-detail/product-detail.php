            ...
            <div id="MainContent" class="main-content" role="main">
                ...
                <div class="bredcrumbWrap">
                    <div class="container breadcrumbs">
                        <a href="index.html" title="Back to the home page">Trang chủ</a><span aria-hidden="true">›</span><span><?= $data['TenSP'] ?></span>
                    </div>
                </div>
                <!--End Breadcrumb-->
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="product-details-img product-single__photos bottom">
                                    <div class="zoompro-wrap product-zoom-right pl-20">
                                        ...
                                        <div class="product-labels"><span class="lbl on-sale">Sale</span><span class="lbl pr-label1">Mới</span></div>
                                ...
                                <div class="prFeatures">
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 feature">
                                            ...
                                            <div class="details"><h3>Thanh toán An toàn</h3>Thanh toán với các phương thức thanh toán phổ biến nhất thế giới</div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 feature">

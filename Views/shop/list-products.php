        ...
        <div class="col-6 col-sm-6 col-md-4 col-lg-4 item">
            ...
            <div class="product-image">
                ...
                <a href="?act=detail&xuli=detail&id=<?=$value['MaSP']?>">
                    ...
                    <img class="primary blur-up lazyload" data-src="" src="assets/<?=$value['HinhAnh1']?>" alt="image" title="Sản phẩm">
                    <!-- End image -->
                    <!-- Hover image -->
                    <img class="hover blur-up lazyload" data-src="" src="assets/<?=$value['HinhAnh2']?>" alt="image" title="Sản phẩm">
                    <!-- End hover image -->
                    <!-- product label -->
            ...
            <div class="product-details text-center">
                ...
                <div class="product-price">
                    <span class="price"><?=number_format($value['DonGia'])?> đ</span>
                </div>
                <!-- End product price -->
